...
void main() {
  group('Auto Route Tests', () {
    testWidgets('AppRouter should be properly configured', (WidgetTester tester) async {
    ...
    testWidgets('Router config should work with MaterialApp', (WidgetTester tester) async {
      LocalStorage();
      final router = AppRouter();
