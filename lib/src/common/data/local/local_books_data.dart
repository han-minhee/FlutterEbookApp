...
class LocalBooksData {
  static List<Entry> get popularBooks => [
        ...
        _createBook(
          ...
          summary:
              'A novel written by English author Charles Lutwidge Dodgson under the pseudonym Lewis Carroll. It tells of a young girl named Alice falling through a rabbit hole into a fantasy world populated by peculiar, anthropomorphic creatures.',
        ...
        _createBook(
          ...
          summary:
              'A Gothic novel written by English author Mary Shelley. The story tells of Victor Frankenstein, a young scientist who creates a hideous, sapient creature in an unorthodox scientific experiment.',
        ...
        _createBook(
          ...
          summary:
              "A collection of twelve short stories featuring the famous detective Sherlock Holmes and his companion Dr. Watson. These stories showcase Holmes' brilliant deductive reasoning and investigative skills.",
        ...
        _createBook(
          ...
          author: 'Mark Twain',
          summary:
              'A novel about a young boy growing up along the Mississippi River. The story is set in the fictional town of St. Petersburg, inspired by Hannibal, Missouri, where Twain lived as a boy.',
        ...
        _createBook(
          ...
          summary:
              "An epic sea story of Captain Ahab's voyage in pursuit of Moby Dick, the legendary white whale. This novel is considered one of the greatest American novels ever written.",
  ...
  static List<Entry> get recentBooks => [
        _createBook(
          ...
          author: 'George Eliot',
          summary:
              'A novel set in the fictitious Midlands town of Middlemarch during 1829-1832. It follows the lives of several residents as they navigate love, politics, and social change.',
        ...
        _createBook(
          ...
          summary:
              'The story of Pip, an orphan boy who rises from humble beginnings to become a gentleman in Victorian England. A tale of personal growth, love, and the true meaning of being a gentleman.',
        ...
        _createBook(
          ...
          author: 'Charles Dickens',
          summary:
              'Set in London and Paris before and during the French Revolution, this novel tells the story of the French Doctor Manette and his daughter Lucie.',
